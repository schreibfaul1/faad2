...
static const int32_t Q_div_tab[31] = {
...
/* calculates 1/(1+Q) */
/* [0..1] */
static int32_t calc_Q_div(sbr_info *sbr, uint8_t ch, uint8_t m, uint8_t l)
{
    if (sbr->bs_coupling)
    {
        /* left channel */
...
static const int32_t Q_div2_tab[31] = {
...
/* calculates Q/(1+Q) */
/* [0..1] */
static int32_t calc_Q_div2(sbr_info *sbr, uint8_t ch, uint8_t m, uint8_t l)
{
    if (sbr->bs_coupling)
    {
        if ((sbr->Q[0][m][l] < 0 || sbr->Q[0][m][l] > 30) ||
...
static const int32_t E_pan_tab[25] = {
